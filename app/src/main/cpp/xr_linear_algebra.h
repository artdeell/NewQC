...
inline static void XrMatrix4x4f_CreateViewMatrix(XrMatrix4x4f* result, const XrVector3f* translation,
                                          const XrQuaternionf* rotation) {
    XrMatrix4x4f translationMatrix, rotationMatrix, invertedRotation;
    XrMatrix4x4f_CreateFromQuaternion(&rotationMatrix, rotation);
    XrMatrix4x4f_Invert(&invertedRotation, &rotationMatrix);
    XrMatrix4x4f_CreateTranslation(&translationMatrix, -translation->x, -translation->y, -translation->z);
    XrMatrix4x4f_Multiply(result, &invertedRotation, &translationMatrix);
}
